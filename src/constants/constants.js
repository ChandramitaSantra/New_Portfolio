export const projects = [
  {
    ...
    description: "Using React, Node.js, Express & MongoDB I  build a Full Stack MERN Application - from start to finish. The App is called Expense Tracker and allows users to keep track of their finances (expenses, amount, transactions).",
      image: '/images/1..png',
      tags: ['MongoDB', 'Express', 'React', 'Node'],
    source: 'https://github.com/sinhadityaforever/github-autopilot',
    visit: 'https://trackifi.vercel.app/',
    id: 0,
  },
  {
    title: ' Modern UI-UX',
  ...
  },
  {
    ...
    image: '/images/4..png',
    tags: ['React', 'Javascript'],
    source: 'https://github.com/ChandramitaSantra/Codepen-Clone-Final',
    visit: 'https://codepen-clone-final-uwd9.vercel.app/',
    id: 3,
  },
];
